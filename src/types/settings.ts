...
export interface SettingsData {
  ...
  collectionTableState?: unknown; //TableState<CardsData>;
  collectionQuery: string;
  collectionMode: string;
  decksTableMode: string;
  decksTableState?: unknown; //TableState<DecksData>;
  economyTableMode: string;
  economyTableState?: unknown; //TableState<TransactionData>;
  enable_keyboard_shortcuts: boolean;
  eventsTableMode: string;
  eventsTableState?: unknown; //TableState<EventTableData>;
  ...
  matchesTableState?: unknown; //TableState<MatchTableData>;
